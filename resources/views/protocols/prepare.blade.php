...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading m-0">Подготовка протокола</h3>
            ...
            <div class="section-body">
               <div class="row">
                   <div class="col-lg-12">
                       <div class="card">
                           <div class="card-body ">
                                {!! Form::open(['url' => '/protocols/' . $protocol->id . '/generate']) !!}
                                    @csrf
                                    <div class="row">
                                    	<div class="form-group col-sm-6">
										    {!! Form::label('num', 'Номер протокола:') !!}
										    {!! Form::text('num', $protocol->num, ['class' => 'form-control']) !!}
										</div>
										...
										<div class="form-group col-sm-6">
										    ...
										    {!! Form::text('points_num', count($points), ['class' => 'form-control']) !!}
										</div>
										...
										<div class="form-group col-sm-6">
										    ...
										    {!! Form::text('field_address', $field->address, ['class' => 'form-control']) !!}
										</div>
